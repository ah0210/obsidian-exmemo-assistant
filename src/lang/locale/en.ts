...
export default {
  ...
  "enableContentOptimizeDesc": "When enabled, will first generate metadata, then optimize article content based on the prompt",
  "contentOptimizePrompt": "Content Optimization Prompt",
  "contentOptimizePromptDesc": "Prompt for optimizing article content",
  "defaultContentOptimizePrompt": "Please optimize this article to make it more fluent, clear, and readable while keeping the original meaning. Only return the optimized article content, no additional explanations.",
  "contentOptimized": "Article content has been optimized",
